<%@ Page Title="" Language="C#" MasterPageFile="~/AcmMaster.master" AutoEventWireup="true" CodeBehind="tbl_DefineLeavePeriod.aspx.cs" Inherits="NewAdmin.tbl_DefineLeavePeriod"  %>
        ...
        <div class="col-md-12">
            <div class="tabbable-custom tabbable-noborder">
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="#">tbl_DefineLeavePeriod</a>
                    </li>
                </ul>
...
<div class="card-body p-9">
	...
	<!--end::Row--><!--begin::Row--><div class="row mb-8"><!--begin::Col-->
		<div class="col-xl-3">
	...
	<!--end::Row--><!--begin::Row--><div class="row mb-8"><!--begin::Col-->
		<div class="col-xl-3">
			<div class="fs-6 fw-semibold mt-2 mb-3">STARTMONTH</div>
		</div>
		<!--end::Col-->
		<!--begin::Col-->
		<div class="col-xl-9 fv-row">
			<asp:DropDownList style="color:" ID="drpStartMonth" runat="server" class="form-control form-control-solid" name="type" value="" ></asp:DropDownList>
		</div>
	</div>
	<!--end::Row--><!--begin::Row--><div class="row mb-8"><!--begin::Col-->
		<div class="col-xl-3">
			<div class="fs-6 fw-semibold mt-2 mb-3">STARTDATE</div>
		</div>
		<!--end::Col-->
		<!--begin::Col-->
		<div class="col-xl-9 fv-row">
			<asp:DropDownList style="color:" ID="drpStartDate" runat="server" class="form-control form-control-solid" name="type" value="" ></asp:DropDownList>
		</div>
	</div>
	<!--end::Row--><!--begin::Row--><div class="row mb-8"><!--begin::Col-->
		<div class="col-xl-3">
	...
	<!--end::Row--><!--begin::Row--><div class="row mb-8"><!--begin::Col-->
		...
		<!--begin::Col-->
		<div class="col-xl-9 fv-row">
			<asp:TextBox style="color:" ID="txtCreatedBy" runat="server" TextMode="MultiLine" class="form-control form-control-solid" name="type" value="" ></asp:TextBox>
		</div>
	</div>
	<!--end::Row--><!--begin::Row--><div class="row mb-8"><!--begin::Col-->
		<div class="col-xl-3">
		...
		<!--begin::Col-->
		<div class="col-xl-9 fv-row">
			<asp:TextBox style="color:" ID="txtCreateDate" runat="server"  Placeholder="MM/DD/YYYY" class="form-control form-control-solid" name="type" value="" ></asp:TextBox><cc1:CalendarExtender ID="TextBoxCreateDate_CalendarExtender" runat="server" Enabled="True" PopupButtonID="calender" TargetControlID="txtCreateDate"></cc1:CalendarExtender>
		</div>
	</div>
	<!--end::Row--></div>
<!--end::Card body-->
				...
				<div class="card card-flush mt-6 mt-xl-9">
					...
					<div class="card-header mt-5">
						...
						<div class="card-title flex-column">
							<h3 class="fw-bold mb-1">tbl_DefineLeavePeriod List</h3>
						</div>
						<!--begin::Card title-->
						<!--begin::Card toolbar-->
...
<th class="min-w-50px">StartMonth</th>
<th class="min-w-50px">StartDate</th>
