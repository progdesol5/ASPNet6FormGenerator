...
namespace NewAdmin
{
    ...
    public partial class TBLCOMPANYSETUP
    {
        public TBLCOMPANYSETUP()
        {
            this.ISSearchDetails = new HashSet<ISSearchDetail>();
        }
        ...
        public Nullable<int> CompanyType_Ref { get; set; }
        ...
        public virtual ICollection<ISSearchDetail> ISSearchDetails { get; set; }
    }
}
