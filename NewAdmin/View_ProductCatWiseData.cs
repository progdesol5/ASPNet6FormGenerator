...
namespace NewAdmin
{
    ...
    public partial class View_ProductCatWiseData
    {
        ...
        public string ProdTypeShort { get; set; }
        public string ProdTypeEnglish { get; set; }
        public string ProdTypeArabic { get; set; }
        public string Serial_Number { get; set; }
        public Nullable<int> ICIT_BR_SIZECOLORSIZECODE { get; set; }
        public string SIZEDESC1 { get; set; }
        public string SIZEDESC2 { get; set; }
        public Nullable<int> ICIT_BR_SIZECOLORCOLORID { get; set; }
        ...
        public Nullable<int> ICIT_BR_PerishableOnHand { get; set; }
        public Nullable<decimal> ICIT_BROnHand { get; set; }
