            ...
            if (line != null)
            {
                ...
                for (int j = 0; j < Listview1.Items.Count(); j++)
                {
                    ...
                    if (check.Checked == true)
                    {
                        ...
                        {
                            txtContent += "<!--begin::Row--><div class=\"row mb-8\">\r\n\t\t<!--bigin::Col-->\r\n\t\t<div class=\"col-xl-1\"></div>\r\n\t\t<!--end::Col-->\r\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-1\">\n\t\t\t<div class=\"fs-6 fw-semibold mt-2 mb-3\">" + txtLabelName.Text + "</div>\n\t\t</div>\n\t\t<!--end::Col-->\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-9 fv-row\">\n\t\t\t<asp:TextBox style=\"color:" + txtcolor.Text + "\" ID=\"txt" + lblFieldName.Text + "\" runat=\"server\" class=\"form-control form-control-solid\" name=\"type\" value=\"\" ></asp:TextBox>\n\t\t</div>\n\t</div>\n\t<!--end::Row-->";
                        }
                        else if (drpControl.SelectedValue == "2")//TextBox with multiline
                        {
                            txtContent += "<!--begin::Row--><div class=\"row mb-8\">\r\n\t\t<!--bigin::Col-->\r\n\t\t<div class=\"col-xl-1\"></div>\r\n\t\t<!--end::Col-->\r\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-1\">\n\t\t\t<div class=\"fs-6 fw-semibold mt-2 mb-3\">" + txtLabelName.Text + "</div>\n\t\t</div>\n\t\t<!--end::Col-->\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-9 fv-row\">\n\t\t\t<asp:TextBox style=\"color:" + txtcolor.Text + "\" ID=\"txt" + lblFieldName.Text + "\" runat=\"server\" TextMode=\"MultiLine\" class=\"form-control form-control-solid\" name=\"type\" value=\"\" ></asp:TextBox>\n\t\t</div>\n\t</div>\n\t<!--end::Row-->";
                        }
                        else if (drpControl.SelectedValue == "3")//TextBox For DateTime
                        {
                            txtContent += "<!--begin::Row--><div class=\"row mb-8\">\r\n\t\t<!--bigin::Col-->\r\n\t\t<div class=\"col-xl-1\"></div>\r\n\t\t<!--end::Col-->\r\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-1\">\n\t\t\t<div class=\"fs-6 fw-semibold mt-2 mb-3\">" + txtLabelName.Text + "</div>\n\t\t</div>\n\t\t<!--end::Col-->\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-9 fv-row\">\n\t\t\t<asp:TextBox style=\"color:" + txtcolor.Text + "\" ID=\"txt" + lblFieldName.Text + "\" runat=\"server\"  Placeholder=\"MM/DD/YYYY\" class=\"form-control form-control-solid\" name=\"type\" value=\"\" ></asp:TextBox><cc1:CalendarExtender ID=\"TextBox" + lblFieldName.Text + "_CalendarExtender\" runat=\"server\" Enabled=\"True\" PopupButtonID=\"calender\" TargetControlID=\"txt" + lblFieldName.Text + "\"></cc1:CalendarExtender>\n\t\t</div>\n\t</div>\n\t<!--end::Row-->";
                        }
                        else if (drpControl.SelectedValue == "4")//DropDownList
                        {
                            txtContent += "<!--begin::Row--><div class=\"row mb-8\">\r\n\t\t<!--bigin::Col-->\r\n\t\t<div class=\"col-xl-1\"></div>\r\n\t\t<!--end::Col-->\r\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-1\">\n\t\t\t<div class=\"fs-6 fw-semibold mt-2 mb-3\">" + txtLabelName.Text + "</div>\n\t\t</div>\n\t\t<!--end::Col-->\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-9 fv-row\">\n\t\t\t<asp:DropDownList style=\"color:" + txtcolor.Text + "\" ID=\"drp" + lblFieldName.Text + "\" runat=\"server\" class=\"form-control form-control-solid\" name=\"type\" value=\"\" ></asp:DropDownList>\n\t\t</div>\n\t</div>\n\t<!--end::Row-->";
                        }
                        else if (drpControl.SelectedValue == "5")//CheckBox
                        {
                            txtContent += "<!--begin::Row--><div class=\"row mb-8\">\r\n\t\t<!--bigin::Col-->\r\n\t\t<div class=\"col-xl-1\"></div>\r\n\t\t<!--end::Col-->\r\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-1\">\n\t\t\t<div class=\"fs-6 fw-semibold mt-2 mb-3\">" + txtLabelName.Text + "</div>\n\t\t</div>\n\t\t<!--end::Col-->\n\t\t<!--begin::Col-->\n\t\t<div class=\"col-xl-9\">\r\n\t\t\t<div class=\"d-flex fw-semibold h-100\">\r\n\t\t\t\t<div class=\"col-xl-9\">\t\n\t\t\t<asp:checkbox style=\"color:" + txtcolor.Text + "\" ID=\"cb" + lblFieldName.Text + "\" class=\"form-check-input\" type=\"checkbox\" value=\"\" runat=\"server\" data-kt-check=\"true\" data-kt-check-target=\"[data-kt-settings-notification=phone]\" ></asp:checkbox>\n\t\t</div>\n\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\n\t<!--end::Row-->";
                        }
                        else
                        {
